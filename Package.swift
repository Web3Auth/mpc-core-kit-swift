...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/tkey/tkey-mpc-swift", branch: "fix/racing"),
        .package(url: "https://github.com/torusresearch/customauth-swift-sdk", branch: "fix/racing"),
        .package(url: "https://github.com/Web3Auth/single-factor-auth-swift", branch: "fix/racing")
    ],
